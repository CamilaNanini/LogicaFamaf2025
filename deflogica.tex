...
\[
\varphi = d_\varphi(v_1, \ldots, v_n)
\]
para declarar que $v_1, \ldots, v_n$ son variables distintas (con $n \ge 1$) tales que 
\[
L_i(\varphi) \subseteq \{v_1, \ldots, v_n\}.
\]
Tal como para el caso de términos, el uso de declaraciones de la forma 
\[
\varphi = d_\varphi(v_1, \ldots, v_n)
\]
será muy útil cuando se combina con ciertas convenciones notacionales que describiremos a continuación.
